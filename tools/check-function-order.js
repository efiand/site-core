...
/** @param {string} [root=process.cwd()] @returns {FunctionSpacingViolation[]} */
...
/** @param {string} [root=process.cwd()] @returns {FunctionOrderViolation[]} */
...
/** @param {string} [root=process.cwd()] @returns {JsdocFormattingViolation[]} */
...
/** @param {string} source @param {number} fromIndex */
...
/** @param {string} source @returns {Array<{ blockStart: number, bodyEnd: number, name: string }>} */
function getTopLevelFunctions(source) {
	/** @type {Array<{ blockStart: number, bodyEnd: number, name: string }>} */
	const functions = [];
	/** @type {string | null} */
	let inString = null;
	let isEscaped = false;
